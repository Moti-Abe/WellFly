...
class RoundtripSearchPage extends StatefulWidget {
  const RoundtripSearchPage({super.key});

  @override
  State<RoundtripSearchPage> createState() => _RoundtripSearchPageState();
}

class _RoundtripSearchPageState extends State<RoundtripSearchPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("round trip")),
